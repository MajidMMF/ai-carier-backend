...
const normalizeInterviewResponse = (data: any, round: string) => {
...
export const analyseResume = TryCatch(async (req: AuthorizationRequest, res) => {
...
export const jobMatcher = TryCatch(async (req: AuthorizationRequest, res) => {
...
export const generateInterview = TryCatch(async (req: AuthorizationRequest, res) => {
...
export const buildResume = TryCatch(async (req: AuthorizationRequest, res) => {
